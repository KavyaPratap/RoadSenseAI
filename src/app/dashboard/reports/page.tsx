...
const MOCK_REPORTS = [
  { id: 'R-101', type: 'Triple Riding', vehicle: 'DL-01-XX-1122', location: 'Hauz Khas, Delhi', date: 'Mar 10, 2026', status: 'Verified', reporter: 'Kavya' },
  { id: 'R-102', type: 'Wrong Side', vehicle: 'MH-02-ZZ-4455', location: 'Marine Drive, Mumbai', date: 'Mar 10, 2026', status: 'Pending', reporter: 'Kavya' },
  { id: 'R-103', type: 'No Helmet', vehicle: 'KA-03-AA-9900', location: 'MG Road, Bangalore', date: 'Mar 09, 2026', status: 'Verified', reporter: 'Rahul S.' },
  { id: 'R-104', type: 'Illegal Parking', vehicle: 'UP-16-BB-3344', location: 'Sector 18, Noida', date: 'Mar 09, 2026', status: 'Verified', reporter: 'Kavya' },
  { id: 'R-105', type: 'Red Light Violation', vehicle: 'DL-09-CC-7788', location: 'Rajiv Chowk, Delhi', date: 'Mar 08, 2026', status: 'Rejected', reporter: 'Amit P.' },
];
                      ...
                      <DialogContent className="max-w-2xl">
                        ...
                        <div className="p-4 bg-muted rounded-lg text-xs space-y-2">
                          <div className="flex items-center gap-2 mb-2">
                            ...
                            <span className="font-bold">Sentinel Verified Report</span>
                          </div>
                          <p><strong>Detected At:</strong> {report.date}, 14:22 IST</p>
